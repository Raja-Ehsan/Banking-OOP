...
class Double_Pointer_Linked{
	...
	{
		head=NULL; //starting with null list
	}
	//used to create node
	void nodeImp(){
		int n         ;                
...
//used to display all the accounts
void display_ALL() { 
...
///////////////////////////////////
//to deposit amount other than 0 and -ve
...
//////////////////////////////////
//search an account by either name or cnic
...
class Man_u:public Bank{
	...
	public:
		...
		int main_manu(){
			...
			do{
			system("cls");
			system("color 08"); //this function set text color
	cout<<"\n\n\n\n\n";
	cout<<"\t\t\t\t\t";
		for(int i=0;i<=33;i++)
	cout<<load;
...
class Login:public Bank{
	...
	cout<<"\t\t\t\t\t"<<load<<"      ~~~~~~~~~~~~~~~~~~~     "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"                              "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"    MUHAMMAD ITQAN ABDULLAH   "<<load<<endl; //Names of
	cout<<"\t\t\t\t\t"<<load<<"       EHSAN RIAZ JANJUA      "<<load<<endl; //Group Members
	cout<<"\t\t\t\t\t"<<load<<"         SHAZAL HAFEEZ        "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"                              "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"                              "<<load<<endl;
	cout<<"\t\t\t\t\t";
	for(int i=0;i<=31;i++)
